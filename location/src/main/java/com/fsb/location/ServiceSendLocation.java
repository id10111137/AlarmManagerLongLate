...
public class ServiceSendLocation extends Service implements LocationListener {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            locationManager.removeUpdates(ServiceSendLocation.this);
        }
    }
